...
function App() {
  return (
    <div className="font-arial dark dark:bg-gradient-to-b dark:from-slate-950 dark:to-slate-700">
      ...
      <section className="sm:m-16 grid grid-cols-2 sm:grid-cols-4 items-center justify-items-center gap-x-8">
        <h2
      ...
      <footer className="columns-1 md:columns-3 gap-8 py-8 px-16 bg-slate-800 text-slate-50 justify-center md:justify-items-center">
        <p>
        ...
        <ul>
          <li>
            <a href="https://www.facebook.com/aespa.official/">Facebook</a>
          </li>
          <li>
            <a href="https://x.com/aespa_official">Twitter</a>
          </li>
          <li>
          ...
          <li>
            <a href="https://www.tiktok.com/@aespa_official?lang=en">Tiktok</a>
          </li>
          <li>
      ...
      <p className="text-center bg-slate-950 text-white p-2">
